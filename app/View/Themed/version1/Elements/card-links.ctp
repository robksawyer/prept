...
echo $this->Html->link($this->Html->image('../img/common/test-icon-22x23.png',array('border'=>0,'width'=>'22','height'=>'23')),array('controller'=>'tests','action'=>'take',$data['Stack']['id']),array('escape'=>false));
?>